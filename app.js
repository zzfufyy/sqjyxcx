const { Completer, Listenable } = require('./utils/function_util');
const { GlobalService, GlobalKey } = require('./service/global_service');
...
App({
  ...
  _initGlobal() {
    // 全局数据存储
    this.state.globalService = new GlobalService(this);
    this.setGlobal(GlobalKey.IndexBootstrap, true);
    this.setGlobal(GlobalKey.UserInfoChanged, new Listenable());
  },
